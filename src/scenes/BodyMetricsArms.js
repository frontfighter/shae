...
class BodyMetricsArms extends Component {
  constructor() {
    super();
    ...
    this.state = {
      ...
      wristCurrent: 0,
      handLengthData: null,
      handLengthComparison: 0,
      handLengthCurrent: 0,
      palmData: null,
      palmComparison: 0,
      palmCurrent: 0,

      isElbowCollapsed: false,
      isJawCollapsed: false,
      isHandLengthCollapsed: false,
      isPalmCollapsed: false,
      isInitial: true,
    };
        ...
        <ScrollView>
          <View style={{ minHeight: height }}>
            ...
            {this.props.gender === "Male" ? (
              ...
              >
                <Image
                  source={require("../resources/icon/maleArms.png")}
                  style={{ alignSelf: "center" }}
                />
                <Image
                  source={require("../resources/icon/elbow_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 216,
                ...
                />
                <Image
                  source={require("../resources/icon/wrist_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 309,
                ...
                />
                <Image
                  source={require("../resources/icon/hand_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 323,
              ...
              >
                <Image
                  source={require("../resources/icon/femaleArms.png")}
                  style={{ alignSelf: "center" }}
                />
                <Image
                  source={require("../resources/icon/elbow_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 231,
                ...
                />
                <Image
                  source={require("../resources/icon/wrist_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 309,
                ...
                />
                <Image
                  source={require("../resources/icon/hand_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 325,
            ...
            {this.state.elbowData !== null &&
            this.state.elbowData.length === 0 &&
            this.state.wristData !== null &&
            this.state.wristData.length === 0 &&
            this.state.handLengthData !== null &&
            this.state.handLengthData.length === 0 &&
            this.state.palmData !== null &&
            this.state.palmData.length === 0 ? (
              <View>
                <Image
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isElbowCollapsed: !this.state.isElbowCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Elbow</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.elbowCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.elbowCurrent}{" "}
                                <Text
                            ...
                            >
                              ...
                              {this.state.elbowComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(this.state.elbowComparison) /
                                          2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(this.state.elbowComparison)
                        ...
                        <Expand value={this.state.isElbowCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.elbowData}
                              minValue={
                                this.getMinValue(this.state.elbowData) ===
                                this.getMaxValue(this.state.elbowData)
                                  ? 0
                                  : this.getMinValue(this.state.elbowData)
                              }
                              maxValue={this.getMaxValue(this.state.elbowData)}
                            />
                          </View>
                        </Expand>
                      </View>
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isWristCollapsed: !this.state.isWristCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Wrist</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.wristCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.wristCurrent}{" "}
                                <Text
                                  style={[styles.cardText, { fontSize: 14 }]}
                                >
                                  {this.props.unit === "standard" ? "in" : "cm"}
                            ...
                            >
                              ...
                              {this.state.wristComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(this.state.wristComparison) /
                                          2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(this.state.wristComparison)
                        ...
                        <Expand value={this.state.isWristCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              ...
                              minValue={
                                this.getMinValue(this.state.wristData) ===
                                this.getMaxValue(this.state.wristData)
                                  ? 0
                                  : this.getMinValue(this.state.wristData)
                              }
                              maxValue={this.getMaxValue(this.state.wristData)}
                            />
                          </View>
                        </Expand>
                      </View>
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isHandLengthCollapsed: !this.state
                                .isHandLengthCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Hand Length</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.handLengthCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.handLengthCurrent}{" "}
                                <Text
                                  style={[styles.cardText, { fontSize: 14 }]}
                                >
                                  {this.props.unit === "standard" ? "in" : "cm"}
                            ...
                            >
                              {this.state.handLengthComparison !== 0 && (
                                <View>
                                  {this.state.handLengthComparison >= 0 ? (
                                    <Image
                                      source={require("../resources/icon/arrowUp_measurements2.png")}
                              ...
                              {this.state.handLengthComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(
                                          this.state.handLengthComparison
                                        ) / 2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(
                              ...
                              {!this.state.isHandLengthCollapsed ? (
                                <Image
                                  source={require("../resources/icon/arrowUp.png")}
                                  style={{
                                    marginLeft: 30,
                        ...
                        <Expand value={this.state.isHandLengthCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.handLengthData}
                              minValue={
                                this.getMinValue(this.state.handLengthData) ===
                                this.getMaxValue(this.state.handLengthData)
                                  ? 0
                                  : this.getMinValue(this.state.handLengthData)
                              }
                              maxValue={this.getMaxValue(
                                this.state.handLengthData
                              )}
                            />
                          </View>
                        </Expand>
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isPalmCollapsed: !this.state.isPalmCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Palm</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.palmCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.palmCurrent}{" "}
                                <Text
                                  style={[styles.cardText, { fontSize: 14 }]}
                                >
                                  {this.props.unit === "standard" ? "in" : "cm"}
                            ...
                            >
                              ...
                              {this.state.palmComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(this.state.palmComparison) /
                                          2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(this.state.palmComparison)
                        ...
                        <Expand value={this.state.isPalmCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.palmData}
                              minValue={
                                this.getMinValue(this.state.palmData) ===
                                this.getMaxValue(this.state.palmData)
                                  ? 0
                                  : this.getMinValue(this.state.palmData)
                              }
                              maxValue={this.getMaxValue(this.state.palmData)}
                            />
                          </View>
                        </Expand>
                      </View>
...
export default BodyMetricsArms;
