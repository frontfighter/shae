...
class BodyMetricsHead extends Component {
  constructor() {
    super();
    ...
    this.state = {
      ...
      isForeheadCollapsed: false,
      isJawCollapsed: false,
      isNeckCollapsed: false,
      isInitial: true,
    };
    ...
    this.setState(
      {
        ...
        pickerTitle:
          typeof this.state.start.dateString !== "undefined"
      ...
      <View style={{ backgroundColor: "rgb(255,255,255)", flex: 1 }}>
        ...
        <ScrollView>
          ...
          {this.props.gender === "Male" ? (
            ...
            >
              <Image
                source={require("../resources/icon/maleHeadNeck.png")}
                style={{ alignSelf: "center" }}
              />
              <Image
                source={require("../resources/icon/forehead_male.png")}
                // 121, 119, 135
                style={{
                  position: "absolute",
                  top: 69,
              ...
              <Image
                source={require("../resources/icon/jaw_male.png")}
                style={{
                  position: "absolute",
                  top: 106,
                  left: 151,
              ...
              <Image
                source={require("../resources/icon/neck_male.png")}
                style={{
                  position: "absolute",
                  top: 158,
                  left: 145,
            ...
            >
              <Image
                source={require("../resources/icon/femaleHeadNeck.png")}
                style={{ alignSelf: "center" }}
              />
              <Image
                source={require("../resources/icon/forehead_female.png")}
                // 121, 119, 135
                style={{
                  position: "absolute",
                  top: 62,
              ...
              <Image
                source={require("../resources/icon/jaw_female.png")}
                style={{
                  position: "absolute",
                  top: 92,
                  left: 151,
              ...
              <Image
                source={require("../resources/icon/neck_female.png")}
                style={{
                  position: "absolute",
                  top: 147,
                  left: 146,
          ...
          {this.state.foreheadData !== null &&
          this.state.foreheadData.length === 0 &&
          this.state.jawData !== null &&
          this.state.jawData.length === 0 &&
          this.state.neckData !== null &&
          this.state.neckData.length === 0 ? (
            <View>
              <Image
              ...
              >
                <View>
                  <TouchableWithoutFeedback
                    onPress={() =>
                      this.setState({
                        isForeheadCollapsed: !this.state.isForeheadCollapsed,
                      })
                    }
                  >
                    <View
                    ...
                    >
                      <View>
                        ...
                        <Text style={styles.cardText}>
                          {this.props.unit === "standard"
                            ? parseFloat(
                                this.state.foreheadCurrent / 2.54
                              ).toFixed(1)
                            : this.state.foreheadCurrent}{" "}
                      ...
                      >
                        {this.state.foreheadComparison !== 0 && (
                          <View>
                            {this.state.foreheadComparison >= 0 ? (
                              <Image
                        ...
                        {this.state.foreheadComparison !== 0 && (
                          <Text style={styles.cardComparison}>
                            {this.props.unit === "standard"
                              ? parseFloat(
                                  Math.abs(this.state.foreheadComparison) / 2.54
                                ).toFixed(1)
                              : parseFloat(
                                  Math.abs(this.state.foreheadComparison)
                                ).toFixed(1)}
                          </Text>
                        )}

                        {!this.state.isForeheadCollapsed ? (
                          <Image
                  ...
                  <Expand value={this.state.isForeheadCollapsed}>
                    <View style={{ height: 209, flex: 1 }}>
                      <MeasurementsChart
                        unit={this.props.unit === "standard" ? "in" : "cm"}
                        data={this.state.foreheadData}
                        minValue={
                          this.getMinValue(this.state.foreheadData) ===
                          this.getMaxValue(this.state.foreheadData)
                            ? 0
                            : this.getMinValue(this.state.foreheadData)
                        }
                        maxValue={this.getMaxValue(this.state.foreheadData)}
                      />
                    </View>
                  </Expand>
                </View>
          ...
          {this.state.jawData !== null && this.state.jawData.length !== 0 && (
            <View
              style={{
                marginTop: 16,
                width: width - 40,
            ...
            >
              <View>
                <TouchableWithoutFeedback
                  onPress={() =>
                    this.setState({
                      isJawCollapsed: !this.state.isJawCollapsed,
                    })
                  }
                >
                  <View
                  ...
                  >
                    <View>
                      <Text style={styles.cardTitle}>Jaw</Text>
                      <Text style={styles.cardText}>
                        {this.props.unit === "standard"
                          ? parseFloat(this.state.jawCurrent / 2.54).toFixed(1)
                          : this.state.jawCurrent}{" "}
                        <Text style={[styles.cardText, { fontSize: 14 }]}>
                          {this.props.unit === "standard" ? "in" : "cm"}
                        </Text>
                      </Text>
                    ...
                    >
                      ...
                      {this.state.jawComparison !== 0 && (
                        <Text style={styles.cardComparison}>
                          {this.props.unit === "standard"
                            ? parseFloat(
                                Math.abs(this.state.jawComparison) / 2.54
                              ).toFixed(1)
                            : parseFloat(
                                Math.abs(this.state.jawComparison)
                              ).toFixed(1)}
                        </Text>
                      )}

                      {!this.state.isJawCollapsed ? (
                        <Image
                          source={require("../resources/icon/arrowUp.png")}
                          style={{
                            marginLeft: 30,
                ...
                <Expand value={this.state.isJawCollapsed}>
                  <View style={{ height: 209, flex: 1 }}>
                    <MeasurementsChart
                      unit={this.props.unit === "standard" ? "in" : "cm"}
                      data={this.state.jawData}
                      minValue={
                        this.getMinValue(this.state.jawData) ===
                        this.getMaxValue(this.state.jawData)
                          ? 0
                          : this.getMinValue(this.state.jawData)
                      }
                      maxValue={this.getMaxValue(this.state.jawData)}
                    />
                  </View>
                </Expand>
              </View>
          ...
          {this.state.neckData !== null && this.state.neckData.length !== 0 && (
            <View
              style={{
                marginTop: 16,
                width: width - 40,
            ...
            >
              <View>
                <TouchableWithoutFeedback
                  onPress={() =>
                    this.setState({
                      isNeckCollapsed: !this.state.isNeckCollapsed,
                    })
                  }
                >
                  <View
                  ...
                  >
                    <View>
                      ...
                      <Text style={styles.cardText}>
                        {this.props.unit === "standard"
                          ? parseFloat(this.state.neckCurrent / 2.54).toFixed(1)
                          : this.state.neckCurrent}{" "}
                        <Text style={[styles.cardText, { fontSize: 14 }]}>
                          {this.props.unit === "standard" ? "in" : "cm"}
                        </Text>
                      </Text>
                    ...
                    >
                      ...
                      {this.state.neckComparison !== 0 && (
                        <Text style={styles.cardComparison}>
                          {this.props.unit === "standard"
                            ? parseFloat(
                                Math.abs(this.state.neckComparison) / 2.54
                              ).toFixed(1)
                            : parseFloat(
                                Math.abs(this.state.neckComparison)
                              ).toFixed(1)}
                        </Text>
                      )}

                      {!this.state.isNeckCollapsed ? (
                        <Image
                          source={require("../resources/icon/arrowUp.png")}
                          style={{
                            marginLeft: 30,
                ...
                <Expand value={this.state.isNeckCollapsed}>
                  <View style={{ height: 209, flex: 1 }}>
                    <MeasurementsChart
                      unit={this.props.unit === "standard" ? "in" : "cm"}
                      data={this.state.neckData}
                      minValue={
                        this.getMinValue(this.state.neckData) ===
                        this.getMaxValue(this.state.neckData)
                          ? 0
                          : this.getMinValue(this.state.neckData)
                      }
                      maxValue={this.getMaxValue(this.state.neckData)}
                    />
                  </View>
                </Expand>
              </View>
...
export default BodyMetricsHead;
