...
class BodyMetricsLegs extends Component {
  constructor() {
    super();
    ...
    this.state = {
      ...
      ankleCurrent: 0,
      footLengthData: null,
      footLengthComparison: 0,
      footLengthCurrent: 0,

      isMidThighCollapsed: false,
      isKneeCollapsed: false,
      isCalfCollapsed: false,
      isAnkleCollapsed: false,
      isFootLengthCollapsed: false,
      isInitial: true,
    };
  ...
  componentDidMount() {
    ...
    this.getData("midThigh");
    this.getData("knee");
    this.getData("calf");
    this.getData("ankle");
    this.getData("footLength");
  }
  ...
  getData = async (type) => {
    ...
    let modType = type === "midThigh" ? "midThigh" : type;
    ...
    this.setState(
      {
        [modType + "Data"]: newArray,
        [modType + "Comparison"]: comparison,
        [modType + "Current"]:
          array.length !== 0 ? array[array.length - 1].value : data.currentUnit, //data.currentUnit,
      },
      () => {
        console.log(`${[modType + "Data"]}`, this.state[modType + "Data"]);
        console.log(
          `${[modType + "Comparison"]}`,
          this.state[modType + "Comparison"]
        );
        console.log(
          `${[modType + "Current"]}`,
          this.state[modType + "Current"]
        );
      }
    );
        ...
        <ScrollView>
          <View style={{ minHeight: height }}>
            ...
            {this.props.gender === "Male" ? (
              ...
              >
                <Image
                  source={require("../resources/icon/maleLegs.png")}
                  style={{ alignSelf: "center" }}
                />
                <Image
                  source={require("../resources/icon/midThigh_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 172,
                ...
                />
                <Image
                  source={require("../resources/icon/knee_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 227,
                ...
                />
                <Image
                  source={require("../resources/icon/calf_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 276,
                ...
                />
                <Image
                  source={require("../resources/icon/ankle_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 347,
                ...
                />
                <Image
                  source={require("../resources/icon/footLength_male.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 389,
              ...
              >
                <Image
                  source={require("../resources/icon/femaleLegs.png")}
                  style={{ alignSelf: "center" }}
                />
                <Image
                  source={require("../resources/icon/midThigh_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 172,
                ...
                />
                <Image
                  source={require("../resources/icon/knee_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 234,
                ...
                />
                <Image
                  source={require("../resources/icon/calf_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 271,
                ...
                />
                <Image
                  source={require("../resources/icon/ankle_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 348,
                ...
                />
                <Image
                  source={require("../resources/icon/footLength_female.png")}
                  // 121, 119, 135
                  style={{
                    position: "absolute",
                    top: 389,
            ...
            {this.state.midThighData !== null &&
            this.state.midThighData.length === 0 &&
            this.state.kneeData !== null &&
            this.state.kneeData.length === 0 &&
            this.state.calfData !== null &&
            this.state.calfData.length === 0 &&
            this.state.ankleData !== null &&
            this.state.ankleData.length === 0 &&
            this.state.footLengthData !== null &&
            this.state.footLengthData.length === 0 ? (
              <View>
                <Image
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isMidThighCollapsed: !this.state
                                .isMidThighCollapsed,
                            })
                          }
                        >
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Mid-Thigh</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.midThighCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.midThighCurrent}{" "}
                                <Text
                            ...
                            >
                              {this.state.midThighComparison !== 0 && (
                                <View>
                                  {this.state.midThighComparison >= 0 ? (
                                    <Image
                              ...
                              {this.state.midThighComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(
                                          this.state.midThighComparison
                                        ) / 2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(this.state.midThighComparison)
                                      ).toFixed(1)}
                                </Text>
                              )}

                              {!this.state.isMidThighCollapsed ? (
                                <Image
                        ...
                        <Expand value={this.state.isMidThighCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.midThighData}
                              minValue={
                                this.getMinValue(this.state.midThighData) ===
                                this.getMaxValue(this.state.midThighData)
                                  ? 0
                                  : this.getMinValue(this.state.midThighData)
                              }
                              maxValue={this.getMaxValue(
                                this.state.midThighData
                              )}
                            />
                          </View>
                        </Expand>
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isKneeCollapsed: !this.state.isKneeCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Knee</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.kneeCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.kneeCurrent}{" "}
                                <Text
                                  style={[styles.cardText, { fontSize: 14 }]}
                                >
                                  {this.props.unit === "standard" ? "in" : "cm"}
                            ...
                            >
                              ...
                              {this.state.kneeComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(this.state.kneeComparison) /
                                          2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(this.state.kneeComparison)
                        ...
                        <Expand value={this.state.isKneeCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.kneeData}
                              minValue={
                                this.getMinValue(this.state.kneeData) ===
                                this.getMaxValue(this.state.kneeData)
                                  ? 0
                                  : this.getMinValue(this.state.kneeData)
                              }
                              maxValue={this.getMaxValue(this.state.kneeData)}
                            />
                          </View>
                        </Expand>
                      </View>
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isCalfCollapsed: !this.state.isCalfCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Calf</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.calfCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.calfCurrent}{" "}
                                <Text
                                  style={[styles.cardText, { fontSize: 14 }]}
                                >
                                  {this.props.unit === "standard" ? "in" : "cm"}
                            ...
                            >
                              ...
                              {this.state.calfComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(this.state.calfComparison) /
                                          2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(this.state.calfComparison)
                        ...
                        <Expand value={this.state.isCalfCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.calfData}
                              minValue={
                                this.getMinValue(this.state.calfData) ===
                                this.getMaxValue(this.state.calfData)
                                  ? 0
                                  : this.getMinValue(this.state.calfData)
                              }
                              maxValue={this.getMaxValue(this.state.calfData)}
                            />
                          </View>
                        </Expand>
                      </View>
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isAnkleCollapsed: !this.state.isAnkleCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              ...
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.ankleCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.ankleCurrent}{" "}
                                <Text
                                  style={[styles.cardText, { fontSize: 14 }]}
                                >
                                  {this.props.unit === "standard" ? "in" : "cm"}
                            ...
                            >
                              ...
                              {this.state.ankleComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(this.state.ankleComparison) /
                                          2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(this.state.ankleComparison)
                        ...
                        <Expand value={this.state.isAnkleCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.ankleData}
                              minValue={
                                this.getMinValue(this.state.ankleData) ===
                                this.getMaxValue(this.state.ankleData)
                                  ? 0
                                  : this.getMinValue(this.state.ankleData)
                              }
                              maxValue={this.getMaxValue(this.state.ankleData)}
                            />
                          </View>
                        </Expand>
                      </View>
                    ...
                    >
                      <View>
                        <TouchableWithoutFeedback
                          onPress={() =>
                            this.setState({
                              isFootLengthCollapsed: !this.state
                                .isFootLengthCollapsed,
                            })
                          }
                        >
                          <View
                          ...
                          >
                            <View>
                              <Text style={styles.cardTitle}>Foot Length</Text>
                              <Text style={styles.cardText}>
                                {this.props.unit === "standard"
                                  ? parseFloat(
                                      this.state.footLengthCurrent / 2.54
                                    ).toFixed(1)
                                  : this.state.footLengthCurrent}{" "}
                                <Text
                                  style={[styles.cardText, { fontSize: 14 }]}
                                >
                                  {this.props.unit === "standard" ? "in" : "cm"}
                            ...
                            >
                              {this.state.footLengthComparison !== 0 && (
                                <View>
                                  {this.state.footLengthComparison >= 0 ? (
                                    <Image
                                      source={require("../resources/icon/arrowUp_measurements2.png")}
                              ...
                              {this.state.footLengthComparison !== 0 && (
                                <Text style={styles.cardComparison}>
                                  {this.props.unit === "standard"
                                    ? parseFloat(
                                        Math.abs(
                                          this.state.footLengthComparison
                                        ) / 2.54
                                      ).toFixed(1)
                                    : parseFloat(
                                        Math.abs(
                              ...
                              {!this.state.isFootLengthCollapsed ? (
                                <Image
                                  source={require("../resources/icon/arrowUp.png")}
                                  style={{
                                    marginLeft: 30,
                        ...
                        <Expand value={this.state.isFootLengthCollapsed}>
                          <View style={{ height: 209, flex: 1 }}>
                            <MeasurementsChart
                              unit={
                                this.props.unit === "standard" ? "in" : "cm"
                              }
                              data={this.state.footLengthData}
                              minValue={
                                this.getMinValue(this.state.footLengthData) ===
                                this.getMaxValue(this.state.footLengthData)
                                  ? 0
                                  : this.getMinValue(this.state.footLengthData)
                              }
                              maxValue={this.getMaxValue(
                                this.state.footLengthData
                              )}
                            />
                          </View>
                        </Expand>
...
export default BodyMetricsLegs;
